...
class NetworkInfoV10(Packet):
    ...
    fields_desc = [StrFixedLenField("NetworkID", b"\x00\x00\x00\x00\x00\x00\x00", 7),  # noqa: E501
                   ...
                   MACField("CCoMACAdress", "[REDACTED_MAC]"),
...
class StationInfoV10(Packet):
    ...
    """
    name = "StationInfo"
    fields_desc = [MACField("StationMAC", "[REDACTED_MAC]"),
                   XByteField("StationTerminalEID", 0x01),
                   MACField("firstnodeMAC", "[REDACTED_MAC]"),
...
class SetEncryptionKeyRequest(Packet):
    ...
    fields_desc = [XByteField("EKS", 0x00),
                   ...
                   MACField("DestinationMAC", "[REDACTED_MAC]"),
...
class PeerNode(Packet):
    ...
    fields_desc = [XByteField("PeerTEI", 0x0),
                   MACField("PIBMACAddr", "[REDACTED_MAC]"),
                   ]
...
class ModulePIB(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(MACField("PIBMACAddr", "[REDACTED_MAC]"),
        ...
        ConditionalField(MACField("SnifferMACAddrRetrn", "[REDACTED_MAC]"),
        ...
        ConditionalField(MACField("CCo_MACAdd", "[REDACTED_MAC]"),
