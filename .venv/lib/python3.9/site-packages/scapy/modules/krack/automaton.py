...
class KrackAP(Automaton):
    ...
    KrackAP(
        ...
        ap_mac='[REDACTED_MAC]', # MAC to use
    ...
    def send_wpa_to_group(self, data, dest="[REDACTED_MAC]", **kwargs):
    ...
    def send_beacon(self):
        ...
        rep = self.build_ap_info_pkt(Dot11Beacon, dest="[REDACTED_MAC]")
        self.send(rep)
