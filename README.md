...
**Core:** [MIT License](LICENSE) — free for personal, commercial, and enterprise use.

**Enterprise features** (SLA, priority support, advanced dashboards): see [`docs/COMMERCIAL.md`](docs/COMMERCIAL.md)
